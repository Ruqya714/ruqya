...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (insertError) {
        // Table might not exist yet — just show success
    ...
    <>
      ...
      <section className="gradient-hero text-white py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl lg:text-5xl font-bold mb-6">اتصل بنا</h1>
          <p className="text-lg text-gray-200 leading-relaxed max-w-2xl mx-auto">
            نسعد بتواصلكم معنا. يمكنكم إرسال رسالة أو التواصل مباشرة عبر
            الوسائل التالية
          </p>
        </div>
      </section>
            ...
            <div className="space-y-6">
              ...
              {[
                ...
                },
                {
                  icon: <Clock size={20} />,
                  label: "ساعات العمل",
                  value: "السبت - الخميس: 10:00 - 22:00",
                  dir: "rtl" as const,
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex items-start gap-4 p-4 rounded-xl bg-white border border-border hover:border-primary/20 transition-colors"
                >
                ...
                {sent ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-text-secondary">
                      سنتواصل معك في أقرب وقت ممكن بإذن الله
                    </p>
                    <button
