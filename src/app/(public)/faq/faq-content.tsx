      ...
      <section className="gradient-hero text-white py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-200 leading-relaxed max-w-2xl mx-auto">
            نجيب على أبرز التساؤلات والاستفسارات ويمكنكم الحصول على المزيد من خلال تسجيل حالتكم حيث سيجيب موظف الاستقبال على جميع أسئلتكم بإذن الله هدفنا تقديم خدمة مميزة لكم حتى في استفساراتكم والشفافية أهم أهدافنا
          </p>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-text-secondary mb-8">
            تواصل معنا مباشرة وسنسعد بالإجابة على جميع استفساراتك
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/booking"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-accent text-white font-medium hover:bg-accent-light transition-all"
            >
              <Phone size={18} />
              سجّل حالتك
            </Link>
