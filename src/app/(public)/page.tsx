            ...
            {[
              {
                ...
                desc: "جلسة استشارية صوتية مع أحد المعالجين لتقييم الحالة وتحديد خطة العلاج المناسبة",
                color: "primary",
              },
              {
                icon: <BookOpen size={24} />,
                title: "التشخيص والعلاج",
                desc: "جلسة رقية شرعية كاملة مع تشخيص دقيق للحالة ووصف البرنامج العلاجي",
                color: "accent",
              },
              {
                icon: <Heart size={24} />,
                title: "العلاج بإشراف خاص",
                desc: "برنامج علاجي متكامل بإشراف مباشر من المعالج مع متابعة مستمرة حتى التعافي",
                color: "primary",
              },
              {
                icon: <Star size={24} />,
                title: "الكورسات والدورات",
                desc: "دورات تعليمية في التحصين والرقية الذاتية والعلاج بالقرآن الكريم",
                color: "accent",
              },
            ].map((service, i) => (
              <div
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                items: ["الأمراض المستعصية", "تأخر الإنجاب", "الآلام المزمنة"],
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-3">
            {[
              {
                q: "كيف تتم الاستشارة الأونلاين؟",
                a: "تتم الاستشارة عبر مكالمة صوتية مع أحد المعالجين المتخصصين. يتم تحديد الموعد المناسب لك بعد الحجز من خلال الموقع.",
              },
              {
                q: "هل العلاج عن بُعد فعّال؟",
                a: "نعم بإذن الله. الرقية الشرعية فعّالة سواء كانت حضورية أو عن بُعد. العبرة بتوجه القلب إلى الله والأخذ بالأسباب الشرعية.",
              },
              {
                q: "كم تستغرق مدة العلاج؟",
                a: "تختلف مدة العلاج من حالة لأخرى. بعض الحالات تتحسن من الجلسة الأولى، وبعضها يحتاج لبرنامج علاجي متكامل قد يمتد لعدة أسابيع.",
              },
            ].map((faq, i) => (
              <details
                key={i}
